// -------------------------------------------------------------
// 
// File Name: C:\Users\team06\Documents\MATLAB\Examples\R2022b\visionhdl\BlobAnalysisExample\verilog_hdl\BlobAnalysisHDL\Pixel_Stream_Aligner.v
...
// Source Path: BlobAnalysisHDL/BlobDetector/CCA_Algorithm/Pixel Stream Aligner
// Hierarchy Level: 2
// 
...
module Pixel_Stream_Aligner
  ...
  wire refzeroconst_2;
  reg  refpixelInReg;
  reg  [0:7] refpixdlyline_reg;  // ufix1 [8]
  wire [0:7] refpixdlyline_reg_next;  // ufix1 [8]
  wire refpixeldly;
  wire refpixelOutReg;
  reg  refPixelOut;
  ...
  SimpleDualPortRAM_singlebit #(.AddrWidth(14),
                                .DataWidth(1)
                                )
                              u_pixelRAM (.clk(clk),
                                          .enb(enb),
  ...
  assign pixelOutReg = (pixelOutValid == 1'b0 ? pixzeroconst :
              RAMrddata);
  ...
  always @(posedge clk or posedge reset)
    begin : refpixdlyline_process
      if (reset == 1'b1) begin
        refpixdlyline_reg[0] <= 1'b0;
        refpixdlyline_reg[1] <= 1'b0;
        refpixdlyline_reg[2] <= 1'b0;
        refpixdlyline_reg[3] <= 1'b0;
        refpixdlyline_reg[4] <= 1'b0;
        refpixdlyline_reg[5] <= 1'b0;
        refpixdlyline_reg[6] <= 1'b0;
        refpixdlyline_reg[7] <= 1'b0;
      end
      else begin
        if (enb) begin

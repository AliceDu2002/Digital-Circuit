// -------------------------------------------------------------
// 
// File Name: C:\Users\team06\Documents\MATLAB\Examples\R2022b\visionhdl\BlobAnalysisExample\verilog_hdl\BlobAnalysisHDL\Pixel_Stream_Aligner_block.v
...
// -------------------------------------------------------------
// 
// Module: Pixel_Stream_Aligner_block
// Source Path: BlobAnalysisHDL/BlobDetector/Pixel Stream Aligner
// Hierarchy Level: 1
// 
...
module Pixel_Stream_Aligner_block
  ...
  input   in1_vEnd;
  input   in1_valid;
  input   [7:0] in2_0;  // uint8
  input   [7:0] in2_1;  // uint8
  input   [7:0] in2_2;  // uint8
  input   in3_hStart;
  input   in3_hEnd;
  input   in3_vStart;
  input   in3_vEnd;
  ...
  reg [7:0] refpixelInReg1comp;  // uint8
  reg [7:0] refpixdlyline_reg [0:7];  // ufix8 [8]
  wire [7:0] refpixdlyline_reg_next [0:7];  // ufix8 [8]
  wire [7:0] refpixeldly1comp;  // uint8
  wire [7:0] refpixelOutReg1comp;  // uint8
  reg [7:0] refpixelRegOutMux1comp;  // uint8
  reg [7:0] refpixelInReg2comp;  // uint8
  reg [7:0] refpixdlyline_reg_1 [0:7];  // ufix8 [8]
  wire [7:0] refpixdlyline_reg_next_1 [0:7];  // ufix8 [8]
  wire [7:0] refpixeldly2comp;  // uint8
  wire [7:0] refpixelOutReg2comp;  // uint8
  reg [7:0] refpixelRegOutMux2comp;  // uint8
  reg [7:0] refpixelInReg3comp;  // uint8
  reg [7:0] refpixdlyline_reg_2 [0:7];  // ufix8 [8]
  wire [7:0] refpixdlyline_reg_next_2 [0:7];  // ufix8 [8]
  wire [7:0] refpixeldly3comp;  // uint8
  wire [7:0] refpixelOutReg3comp;  // uint8
  reg [7:0] refpixelRegOutMux3comp;  // uint8
  ...
  SimpleDualPortRAM_generic_block1 #(.AddrWidth(14),
                                     .DataWidth(8)
                                     )
  ...
  always @(posedge clk or posedge reset)
    begin : refpixelIReg_process
      if (reset == 1'b1) begin
        refpixelInReg1comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelInReg1comp <= in2_0;
        end
      end
    end
  ...
  assign refpixeldly1comp = refpixdlyline_reg[7];
  assign refpixdlyline_reg_next[0] = refpixelInReg1comp;
  ...
  assign refpixelOutReg1comp = (pixelValidOutReg == 1'b0 ? refzeroconst_2 :
              refpixeldly1comp);
  ...
  always @(posedge clk or posedge reset)
    begin : refpixelOReg_process
      if (reset == 1'b1) begin
        refpixelRegOutMux1comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelRegOutMux1comp <= refpixelOutReg1comp;
        end
      end
    end
  ...
  assign out1_0 = refpixelRegOutMux1comp;

  always @(posedge clk or posedge reset)
    begin : refpixelIReg_1_process
      if (reset == 1'b1) begin
        refpixelInReg2comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelInReg2comp <= in2_1;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : refpixdlyline_1_process
      if (reset == 1'b1) begin
        refpixdlyline_reg_1[0] <= 8'b00000000;
        refpixdlyline_reg_1[1] <= 8'b00000000;
        refpixdlyline_reg_1[2] <= 8'b00000000;
        refpixdlyline_reg_1[3] <= 8'b00000000;
        refpixdlyline_reg_1[4] <= 8'b00000000;
        refpixdlyline_reg_1[5] <= 8'b00000000;
        refpixdlyline_reg_1[6] <= 8'b00000000;
        refpixdlyline_reg_1[7] <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixdlyline_reg_1[0] <= refpixdlyline_reg_next_1[0];
          refpixdlyline_reg_1[1] <= refpixdlyline_reg_next_1[1];
          refpixdlyline_reg_1[2] <= refpixdlyline_reg_next_1[2];
          refpixdlyline_reg_1[3] <= refpixdlyline_reg_next_1[3];
          refpixdlyline_reg_1[4] <= refpixdlyline_reg_next_1[4];
          refpixdlyline_reg_1[5] <= refpixdlyline_reg_next_1[5];
          refpixdlyline_reg_1[6] <= refpixdlyline_reg_next_1[6];
          refpixdlyline_reg_1[7] <= refpixdlyline_reg_next_1[7];
        end
      end
    end

  assign refpixeldly2comp = refpixdlyline_reg_1[7];
  assign refpixdlyline_reg_next_1[0] = refpixelInReg2comp;
  assign refpixdlyline_reg_next_1[1] = refpixdlyline_reg_1[0];
  assign refpixdlyline_reg_next_1[2] = refpixdlyline_reg_1[1];
  assign refpixdlyline_reg_next_1[3] = refpixdlyline_reg_1[2];
  assign refpixdlyline_reg_next_1[4] = refpixdlyline_reg_1[3];
  assign refpixdlyline_reg_next_1[5] = refpixdlyline_reg_1[4];
  assign refpixdlyline_reg_next_1[6] = refpixdlyline_reg_1[5];
  assign refpixdlyline_reg_next_1[7] = refpixdlyline_reg_1[6];



  assign refpixelOutReg2comp = (pixelValidOutReg == 1'b0 ? refzeroconst_2 :
              refpixeldly2comp);



  always @(posedge clk or posedge reset)
    begin : refpixelOReg_1_process
      if (reset == 1'b1) begin
        refpixelRegOutMux2comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelRegOutMux2comp <= refpixelOutReg2comp;
        end
      end
    end
  ...
  assign out1_1 = refpixelRegOutMux2comp;

  always @(posedge clk or posedge reset)
    begin : refpixelIReg_2_process
      if (reset == 1'b1) begin
        refpixelInReg3comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelInReg3comp <= in2_2;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : refpixdlyline_2_process
      if (reset == 1'b1) begin
        refpixdlyline_reg_2[0] <= 8'b00000000;
        refpixdlyline_reg_2[1] <= 8'b00000000;
        refpixdlyline_reg_2[2] <= 8'b00000000;
        refpixdlyline_reg_2[3] <= 8'b00000000;
        refpixdlyline_reg_2[4] <= 8'b00000000;
        refpixdlyline_reg_2[5] <= 8'b00000000;
        refpixdlyline_reg_2[6] <= 8'b00000000;
        refpixdlyline_reg_2[7] <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixdlyline_reg_2[0] <= refpixdlyline_reg_next_2[0];
          refpixdlyline_reg_2[1] <= refpixdlyline_reg_next_2[1];
          refpixdlyline_reg_2[2] <= refpixdlyline_reg_next_2[2];
          refpixdlyline_reg_2[3] <= refpixdlyline_reg_next_2[3];
          refpixdlyline_reg_2[4] <= refpixdlyline_reg_next_2[4];
          refpixdlyline_reg_2[5] <= refpixdlyline_reg_next_2[5];
          refpixdlyline_reg_2[6] <= refpixdlyline_reg_next_2[6];
          refpixdlyline_reg_2[7] <= refpixdlyline_reg_next_2[7];
        end
      end
    end

  assign refpixeldly3comp = refpixdlyline_reg_2[7];
  assign refpixdlyline_reg_next_2[0] = refpixelInReg3comp;
  assign refpixdlyline_reg_next_2[1] = refpixdlyline_reg_2[0];
  assign refpixdlyline_reg_next_2[2] = refpixdlyline_reg_2[1];
  assign refpixdlyline_reg_next_2[3] = refpixdlyline_reg_2[2];
  assign refpixdlyline_reg_next_2[4] = refpixdlyline_reg_2[3];
  assign refpixdlyline_reg_next_2[5] = refpixdlyline_reg_2[4];
  assign refpixdlyline_reg_next_2[6] = refpixdlyline_reg_2[5];
  assign refpixdlyline_reg_next_2[7] = refpixdlyline_reg_2[6];



  assign refpixelOutReg3comp = (pixelValidOutReg == 1'b0 ? refzeroconst_2 :
              refpixeldly3comp);



  always @(posedge clk or posedge reset)
    begin : refpixelOReg_2_process
      if (reset == 1'b1) begin
        refpixelRegOutMux3comp <= 8'b00000000;
      end
      else begin
        if (enb) begin
          refpixelRegOutMux3comp <= refpixelOutReg3comp;
        end
      end
    end
  ...
  assign out1_2 = refpixelRegOutMux3comp;
...
endmodule  // Pixel_Stream_Aligner_block

// -------------------------------------------------------------
// 
// File Name: C:\Users\team06\Documents\MATLAB\Examples\R2022b\visionhdl\BlobAnalysisExample\verilog_hdl\BlobAnalysisHDL\ErosionCore.v
...
// 
// Module: ErosionCore
// Source Path: BlobAnalysisHDL/BlobDetector/CCA_Algorithm/Closing/ErosionCore
// Hierarchy Level: 3
// 
// Final local minima in binary image
// 
// -------------------------------------------------------------
...
module ErosionCore
  ...
  assign pixelsel = intdelay_reg[1];
  ...
  // Neighborhood
  assign nhood1[0] = 1'b0;
  assign nhood1[1] = 1'b0;
  assign nhood1[2] = 1'b0;
  assign nhood1[3] = 1'b0;
  ...
  // Neighborhood
  assign nhood2[0] = 1'b0;
  assign nhood2[1] = 1'b0;
  assign nhood2[2] = 1'b0;
  assign nhood2[3] = 1'b0;
  ...
  // Neighborhood
  assign nhood3[0] = 1'b0;
  assign nhood3[1] = 1'b0;
  assign nhood3[2] = 1'b0;
  assign nhood3[3] = 1'b0;
  ...
  // Neighborhood
  assign nhood4[0] = 1'b0;
  assign nhood4[1] = 1'b0;
  assign nhood4[2] = 1'b0;
  assign nhood4[3] = 1'b0;
  ...
  assign and_col1 = nhood1_3_1 & (nhood1_2_1 & (nhood1_0_1 & nhood1_1_1));
  ...
  assign and_col2 = nhood2_3_1 & (nhood2_2_1 & (nhood2_0_1 & nhood2_1_1));
  ...
  assign and_col3 = nhood3_3_1 & (nhood3_2_1 & (nhood3_0_1 & nhood3_1_1));
  ...
  assign and_col4 = nhood4_3_1 & (nhood4_2_1 & (nhood4_0_1 & nhood4_1_1));



  assign finaand = and_col4 & (and_col3 & (and_col1 & and_col2));
  ...
  assign hStartKernelOut = intdelay_reg_1[1];
  assign intdelay_reg_next_1[0] = hStartIn;
  ...
  assign hEndKernelOut = intdelay_reg_2[1];
  assign intdelay_reg_next_2[0] = hEndIn;
  ...
  assign vStartKernelOut = intdelay_reg_3[1];
  assign intdelay_reg_next_3[0] = vStartIn;
  ...
  assign vEndKernelOut = intdelay_reg_4[1];
  assign intdelay_reg_next_4[0] = vEndIn;

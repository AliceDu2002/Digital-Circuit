// -------------------------------------------------------------
// 
// File Name: C:\Users\team06\Documents\MATLAB\Examples\R2022b\visionhdl\BlobAnalysisExample\verilog_hdl\BlobAnalysisHDL\LineBuffer_block.v
...
// Source Path: BlobAnalysisHDL/BlobDetector/CCA_Algorithm/Closing/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module LineBuffer_block
  ...
  reg  [0:3] intdelay_reg_6;  // ufix1 [4]
  wire [0:3] intdelay_reg_next_6;  // ufix1 [4]
  wire dataInREG;
  ...
  reg  hEndRREG;
  reg  hStartDRC;
  wire DataMemVector_0;
  wire DataMemVector_1;
  wire DataMemVector_2;
  wire DataMemVector_3;
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire outputProcess;
  wire padShift;
  wire [0:3] DataMemVector;  // boolean [4]
  reg  [0:3] intdelay_reg_9;  // ufix1 [4]
  wire [0:3] intdelay_reg_next_9;  // ufix1 [4]
  wire [0:3] DataMemVectorREG;  // boolean [4]
  wire countEnHC_1;
  reg [10:0] horPadCount;  // ufix11
  reg [10:0] horPadCountREG;  // ufix11
  wire DataMemVectorPadded_0;
  wire DataMemVectorPadded_1;
  wire DataMemVectorPadded_2;
  wire DataMemVectorPadded_3;
  wire [10:0] VerCountOut;  // ufix11
  wire verPadOut_0;
  wire verPadOut_1;
  wire verPadOut_2;
  wire verPadOut_3;
  wire [0:3] verPadOut;  // boolean [4]
  reg  [0:3] reg_reg;  // ufix1 [4]
  wire [0:3] reg_reg_next;  // ufix1 [4]
  wire [0:3] verPadD;  // boolean [4]
  wire [0:3] dataSigOut;  // boolean [4]
  reg  [0:3] reg_reg_1;  // ufix1 [4]
  wire [0:3] reg_reg_next_1;  // ufix1 [4]
  wire [0:3] dataSigPreOD;  // boolean [4]
  wire [0:3] dataOut;  // boolean [4]
  wire ctrlOutZero;
  ...
  DATA_MEMORY_block u_DATA_MEMORY (.clk(clk),
                                   ...
                                   .validIn(validRREG),
                                   .popEn(popEn),  // ufix2
                                   .dataVectorOut_0(DataMemVector_0),  // boolean
                                   .dataVectorOut_1(DataMemVector_1),  // boolean
                                   .dataVectorOut_2(DataMemVector_2),  // boolean
                                   .dataVectorOut_3(DataMemVector_3),  // boolean
                                   .popOut(popReg),
  ...
  assign constZero[0] = 1'b0;
  assign constZero[1] = 1'b0;
  assign constZero[2] = 1'b0;
  assign constZero[3] = 1'b0;
  ...
  assign DataMemVector[3] = DataMemVector_3;
  ...
  assign DataMemVectorREG[3] = intdelay_reg_9[3];
  ...
  assign intdelay_reg_next_9[3] = DataMemVector[3];
  ...
  Horizontal_Padder_block u_Horizontal_Padder (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .dataVectorIn_0(DataMemVectorREG[0]),  // boolean
                                               .dataVectorIn_1(DataMemVectorREG[1]),  // boolean
                                               .dataVectorIn_2(DataMemVectorREG[2]),  // boolean
                                               .dataVectorIn_3(DataMemVectorREG[3]),  // boolean
                                               .horPadCount(horPadCountREG),  // ufix11
                                               .padShift(padShift),
                                               .dataVector_0(DataMemVectorPadded_0),  // boolean
                                               .dataVector_1(DataMemVectorPadded_1),  // boolean
                                               .dataVector_2(DataMemVectorPadded_2),  // boolean
                                               .dataVector_3(DataMemVectorPadded_3)  // boolean
                                               );
  ...
  Vertical_Padder_block u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // boolean
                                           .dataVectorIn_1(DataMemVectorPadded_1),  // boolean
                                           .dataVectorIn_2(DataMemVectorPadded_2),  // boolean
                                           .dataVectorIn_3(DataMemVectorPadded_3),  // boolean
                                           .verPadCount(VerCountOut),  // ufix11
                                           .dataVectorOut_0(verPadOut_0),  // boolean
                                           .dataVectorOut_1(verPadOut_1),  // boolean
                                           .dataVectorOut_2(verPadOut_2),  // boolean
                                           .dataVectorOut_3(verPadOut_3)  // boolean
                                           );

  assign verPadOut[0] = verPadOut_0;
  assign verPadOut[1] = verPadOut_1;
  assign verPadOut[2] = verPadOut_2;
  assign verPadOut[3] = verPadOut_3;
  ...
  assign dataSigOut[2] = (outputProcess == 1'b0 ? constZero[2] :
              verPadD[2]);
  assign dataSigOut[3] = (outputProcess == 1'b0 ? constZero[3] :
              verPadD[3]);
  ...
  assign dataOut[2] = (outputDataREG == 1'b0 ? constZero[2] :
              dataSigPreOD[2]);
  assign dataOut[3] = (outputDataREG == 1'b0 ? constZero[3] :
              dataSigPreOD[3]);

...
// -------------------------------------------------------------
// 
// Module: nfp_convert_fix_17_En0_to_single
// Source Path: BlobAnalysisHDL/BlobDetector/CCA_Algorithm/cca/accum_to_pos/nfp_convert_fix_17_En0_to_single
// Hierarchy Level: 4
// 
...
module nfp_convert_fix_17_En0_to_single
  ...
  input   reset;
  input   enb;
  input   [16:0] nfp_in;  // ufix17
  output  [31:0] nfp_out;  // ufix32


  reg [16:0] Delay_out1;  // ufix17
  ...
  wire signed [16:0] Data_Type_Conversion1_out1;  // sfix17
  wire signed [17:0] Unary_Minus_in0;  // sfix18
  wire [16:0] Unary_Minus_1;  // ufix17
  wire signed [17:0] Unary_Minus_2;  // sfix18
  wire [16:0] Unary_Minus_out1;  // ufix17
  wire [16:0] Switch_out1;  // ufix17
  ...
  wire [127:0] Delay2_reg_next [0:2];  // ufix128 [3]
  wire [127:0] Delay2_out1_3;  // ufix128
  wire signed [8:0] dynamic_shift_zerosig;  // sfix9
  wire signed [8:0] dynamic_shift_selsig;  // sfix9
  wire signed [15:0] dynamic_shift_1;  // int16
  ...
  always @(posedge clk or posedge reset)
    begin : Delay_process
      if (reset == 1'b1) begin
        Delay_out1 <= 17'b00000000000000000;
      end
      else begin
        if (enb) begin
          Delay_out1 <= nfp_in;
  ...
  assign CompareToZero1_out1 = Delay_out1 == 17'b00000000000000000;
  ...
  assign Data_Type_Conversion1_out1 = Delay_out1;



  assign Unary_Minus_1 = Data_Type_Conversion1_out1;
  assign Unary_Minus_2 = {1'b0, Unary_Minus_1};
  assign Unary_Minus_in0 =  - (Unary_Minus_2);
  assign Unary_Minus_out1 = Unary_Minus_in0[16:0];



  assign Switch_out1 = (Logical_Operator_out1 == 1'b0 ? Delay_out1 :
              Unary_Minus_out1);



  assign Data_Type_Conversion_out1 = {111'b0, Switch_out1};
  ...
  assign Constant_out1 = 8'sb01111110;
  ...
  assign dynamic_shift_1 = {{7{dynamic_shift_selsig[8]}}, dynamic_shift_selsig};
  assign Shift_Arithmetic_out1 = Delay2_out1_3 <<< dynamic_shift_1;
...
endmodule  // nfp_convert_fix_17_En0_to_single
